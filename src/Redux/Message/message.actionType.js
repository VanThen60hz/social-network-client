...
export const GET_MESSAGE_FROM_CHAT_REQUEST = "GET_MESSAGE_FROM_CHAT_REQUEST";
export const GET_MESSAGE_FROM_CHAT_SUCCESS = "GET_MESSAGE_FROM_CHAT_SUCCESS";
export const GET_MESSAGE_FROM_CHAT_FAILURE = "GET_MESSAGE_FROM_CHAT_FAILURE";
